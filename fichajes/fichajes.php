...
<body>
    ...
    <main>
                    ...
                    <div class="ultimo-fichaje">
                        ...
                        <?php if ($ultimoFichaje): ?>
                            ...
                            <form action="eliminar_fichaje.php" method="POST">
                                ...
                                <button type="submit" onclick="return confirm('¿Estás seguro de que deseas eliminar este fichaje?')">Eliminar Fichaje</button>
                            </form>
                        <?php else: ?>
            ...
            <a href="../index.php" class="link-atras">Menú Principal</a>
